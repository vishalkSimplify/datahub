...
class Inspector(object):
    ...
    def _get_schema_keys(self,db_name: str, schema: str) -> dict:
        """ will return all keys which should come under the given schema

        Args:
            db_name (str): _description_
            schema (str): Name of the schema to return
        """
        return self.dialect._get_schema_keys(
            self.bind, db_name, schema
        )
    ...
    def get_projection_comment(self, projection_name, schema=None, **kw):
        ...
        """Return information about the projection comment for ``projection_name``.
